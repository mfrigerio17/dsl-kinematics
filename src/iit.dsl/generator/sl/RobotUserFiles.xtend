    ...
    def CMakeLists(Robot robot) '''
        ...
        if (XENO)
          ...
          target_link_libraries(xenoopengl
            ...
            add_executable(compare_fwd_dyn
                ${SL_ROOT}/SL/src/SL_simulation_servo.c
                ${SL_ROOT}/SL/src/SL_userSimulation.c
                ${SL_ROOT}/SL/src/SL_objects.c
                ${SL_ROOT}/SL/src/SL_integrate.c
                ${SOURCE_SIM}
                src/initUserSimulation.c
                src/«slCommon.main_compare_fwd_dyn(robot)».cpp)

             target_link_libraries(compare_fwd_dyn
                ${COMMON_LIBS}
                ${XSIM_LIBS}
                ${IITGENLIB})
